...
ROLES = [

    {
        ...
        "meta": [("Audience", "Everyone — read before your role manual"),
                 ("Covers", "Login, password change, navigation, security")],
        "slides": [
            ...
            ("workflow", "Approval Flow at a Glance", [
                ...
                "                                        |",
                "                               Procurement gains read-only",
                "                               visibility here (Incoming PRs)",
                "                               and may already be sourcing quotes",
                "",
...

    {
        ...
        "meta": [("Approval role", "None — you create, not approve"),
                 ("Key actions", "Create PRs, EFTs, Petty Cash, Expense Claims; track status")],
        "slides": [
            ("two_col", "Who You Are", [
                "## You CAN:",
            ...
            ("workflow", "Approval Workflows", [
                ...
                "                                  |",
                "                         Procurement sees your PR here (read-only)",
                "                         and may already be contacting suppliers",
                "",
            ...
            ("steps", "Task: Track Requests & Handle Rejections", [
                ...
                "-- At pending_finance: Procurement can already see your PR and may be sourcing quotes.",
...

    {
        ...
        "meta": [("Approval stage", "Stage 1 of 3 (PRs) / Stage 1 of 2 (EFT, PC, EC, Issue Slips)"),
                 ("Target turnaround", "48 hours for PRs; same day for Petty Cash")],
        "slides": [
            ("two_col", "Who You Are", [
                "## You CAN:",
            ...
            ("workflow", "Workflow — Your Position", [
                ...
                " (Finance reviews;  (initiator sees comment)",
                "  Procurement gains",
            ...
            ("two_col", "Approve vs Reject", [
                ...
                "Finance is notified by email",
                "Procurement gains read-only view of the PR immediately",
                "## Target turnaround:",
...

    {
        ...
        "meta": [("Approval stage", "Stage 2 — after HOD, before MD"),
                 ("Extra", "Budgets, FX rates, GRN approvals, Procurement coordination")],
        "slides": [
            ("two_col", "Who You Are", [
                "## You CAN:",
                ...
                "## Note:",
                "When a PR reaches pending_finance, Procurement already has read-only visibility via their Incoming PRs view and may be collecting quotes in parallel.",
            ]),
            ("workflow", "Workflow — Your Position", [
                "            [HOD approved]",
                "                  |",
                ...
                "      | (Procurement also sees   |",
                "      |  this PR read-only and   |",
                "      |  may be sourcing quotes) |",
                "      +--------------------------+",
                "                  |",
                "         approve / reject",
                "                  |",
            ...
            ("steps", "Task: Review & Approve a Financial Request", [
                ...
                "If Procurement has flagged a sourcing concern about this PR, factor it in before approving.",
...

    {
        ...
        "slides": [
            ...
            ("workflow", "Workflow — Your Position", [
                ...
                "                          |                       |",
                "                  Procurement sees PR        pending_md  <-- your queue",
                "                  read-only; quotes may           |",
                "                  already be prepared      approve / reject",
                "                                                   |",
                "                                    +--------------+------------+",
                "                                    |                           |",
                "                                    v                           v",
                "                                approved                    rejected",
                "                         (Procurement executes PO)  (initiator notified)",
            ]),
            ("steps", "Task: Review a High-Value Request", [
                ...
                "Check the adjudication section — Procurement should have quotes and a winning vendor ready. If quotes are missing, contact Procurement before approving.",
            ...
            ("two_col", "Approve vs Reject", [
                ...
                "Procurement proceeds to issue a PO — they may already have the vendor confirmed",
            ], [
                "## To Reject:",
...

    {
        ...
        "subtitle": "Vendor management · Quote collection · Adjudication · Early sourcing",
        "meta": [("Approval role", "None formal — you execute after MD approval"),
                 ("Early sourcing", "Incoming PRs view — start at pending_finance"),
                 ("Key responsibility", "Vendor selection and order execution")],
        "slides": [
            ("two_col", "Who You Are", [
                "## You CAN:",
                "Monitor Incoming PRs — read-only view of PRs at pending_finance / pending_md",
                ...
                "Change amounts or items on any PR (Incoming PRs is read-only)",
                "Manage users or system settings (Admin only)",
                "## Your responsibilities:",
                "Start sourcing early — monitor Incoming PRs from pending_finance",
            ...
            ("workflow", "Workflow — Your Position", [
                ...
                "                                        |                               |",
                "                               INCOMING PRs VIEW                       v",
                "                               (read-only) — you                  YOU run adjudication,",
                "                               start collecting quotes             upload quotes,",
                "                               from suppliers here                 issue PO outside system",
                "",
                "  Typical sub-flow:",
                "    1. PR appears in Incoming PRs (With Finance or With MD).",
                "    2. View PR details (read-only) to understand requirements.",
                "    3. Contact vendors externally, collect written quotes.",
                "    4. Once PR is approved, upload quotes into the system.",
                "    5. Run adjudication → select winning vendor.",
                "    6. Issue PO to the winning vendor.",
            ]),
            ("steps", "Task: Monitor Incoming PRs", [
                "Sidebar → Procurement → Incoming PRs  (or click 'PRs In Pipeline' on Dashboard).",
                "The list shows all PRs at 'With Finance' (pending_finance) or 'With MD' (pending_md).",
                "Use the search bar to filter by PR number, title, or department.",
                "Click View on any row to open the PR in read-only detail mode.",
                "Review items, quantities, required date, and any HOD notes.",
                "Begin contacting vendors externally — collect informal quotes in parallel with the approval process.",
                "Upload quotes and run adjudication only after the PR is fully approved.",
            ], "Incoming PRs is read-only. You cannot add quotes or take actions until the PR is approved."),
            ("steps", "Task: Collect & Add Quotes", [
                "Once a PR is approved, open it from Sidebar → Procurement → Approved Requisitions.",
                "Scroll to the Quotes section. Click Add Quote.",
                "Select the Vendor from the master list (add them first via Administration → Vendors if new).",
                "Enter unit price, currency, attach the quote PDF, enter validity period.",
                "Repeat for each supplier — aim for at least 3 quotes for items above the unquoted limit.",
                "Once all quotes are in, proceed to adjudication.",
            ], "Start collecting quotes externally while the PR is still in Incoming PRs. Upload them here after approval."),
            ("steps", "Task: Run Adjudication", [
                "Sidebar → Procurement → Adjudication.",
                "Find the PR and open its adjudication view.",
                "Compare the quotes: price (all converted to ZMW), delivery time, quality/track record.",
            ...
            ("bullets", "Vendor Management", [
                ...
                "To deactivate: set Status to inactive — vendor disappears from dropdowns but historical quotes remain",
                "## Bulk upload:",
...

    {
        ...
        "meta": [("Account flag", "'Can Access Stores' must be enabled on your profile"),
                 ...
                 ("Key link", "Your GRN closes the loop on every approved Purchase Requisition")],
        "slides": [
            ("two_col", "Who You Are", [
                "## You CAN:",
                ...
                "Always link a GRN to the correct approved PR",
                "Only issue stock from an approved GRN",
                "Keep the Stock Items list free of duplicates",
                "Notify Finance promptly when a GRN is created so they can approve without delay",
            ]),
            ("workflow", "Where You Fit in the Full Supply Chain", [
                "  [Dept submits PR] --> HOD approves --> Finance approves --> MD approves (if high value)",
                "                                                                      |",
                "                                                                  approved",
                "                                                                      |",
                "                                                   Procurement raises PO with the vendor",
                "                                                                      |",
                "                                                          Supplier delivers goods",
                "                                                                      |",
                "                                                    YOU create a GRN linked to the PR",
                "                                                                      |",
                "                                                         Finance approves the GRN",
                "                                                                      |",
                "                                                    Stock is available in the register",
                "                                                                      |",
                "                                          YOU create Issue Slip → goods leave to dept",
            ]),
            ("workflow", "Stores Document Workflows", [
                "GOODS IN (GRN):",
            ...
            ], "Always link the GRN to the correct Reference PR — this is how the system connects deliveries to the original purchase request."),
            ...
            ("two_col", "Picking Slips & Stock Register", [
                ...
                "Shows: Stock In (approved GRNs) minus Stock Out (approved Issue Slips) minus Reserved",
                "Available = what can currently be issued",
                "Check this before creating an Issue Slip",
                "## Stock Items",
            ...
            ("bullets", "Common Pitfalls & Checklist", [
                "## Before creating a GRN — check:",
                "The Reference PR exists and is at status approved",
                "Quantities on the delivery note match what Procurement ordered (raise any shortfall with Procurement)",
                "The supplier on the delivery note matches the vendor on the PR",
                "You have the physical delivery note or invoice to attach",
                "## Before creating an Issue Slip — check:",
                "The GRN is approved (not still pending_approval)",
                "There is enough available stock in the Register",
                "The recipient department is correct — stock deductions cannot be reversed",
                "## Common mistakes:",
                "GRN linked to wrong PR → the stock register can't reconcile correctly",
                "Issue Slip created before GRN is Finance-approved → submission blocked",
                "Over-issuing by entering wrong quantities → the system prevents this but double-check",
            ]),
        ],
    },

    {
        ...
        "meta": [("Access", "Everything — no hidden menus"),
                 ...
                 ("Visibility", "You see all views including Procurement's Incoming PRs")],
        "slides": [
            ("two_col", "Who You Are", [
                "## You CAN:",
                ...
                "See every form and every view in the system (including Incoming PRs)",
            ...
            ("two_col", "Role Capabilities — What Each Role Unlocks", [
                "## initiator",
                "Create PRs, EFTs, Petty Cash, Expense Claims",
                "View own submissions only",
                "## hod",
                "Everything initiator can do",
                "Approve / reject dept requests at Stage 1",
                "View dept spend reports",
                "## procurement",
                "Incoming PRs view (read-only at pending_finance / pending_md)",
                "Add quotes and run adjudication on approved PRs",
                "Manage vendor master list",
                "View all PRs system-wide",
            ], [
                "## finance",
                "Approve / reject at Stage 2 (pending_finance)",
                "Approve GRNs and Issue Slips",
                "Edit budgets and FX rates",
                "Full analytics access",
                "## md",
                "Final approval on high-value PRs (pending_md)",
                "View everything; full analytics",
                "## admin",
                "All of the above plus user management, audit log, client list",
                "Incoming PRs view visible (same as Procurement)",
                "## stores (flag, not a role)",
                "Unlocks Stores module: GRNs, Issue Slips, Picking Slips, Stock Register",
            ]),
            ("steps", "Task: Create a User", [
                ...
                "Assign Role: initiator / hod / procurement / finance / md / admin. (Procurement gets Incoming PRs and vendor management automatically.)",
                "Tick Is HOD if this person heads their department. Set Supervisor Name to route their requests.",
                "Tick Can Access Stores if the user needs GRNs, Issue Slips, and the Stock Register.",
                "Click Save. Account is active immediately; flagged for forced password change on first login.",
